...
batch_items = Table('batch_items', metadata, ident(), Column('batch_id', String(100), nullable=False,index=True), Column('source_id', String(100), nullable=False), Column('job_id', String(100)), Column('state', String(30), nullable=False,default='pending'), Column('error', Text), UniqueConstraint('batch_id','source_id'))
